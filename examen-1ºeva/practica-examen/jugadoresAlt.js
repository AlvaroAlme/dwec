 ...
 *  ↓↓↓ Para ello puedes usar la técnica de Objetos enlazados con Object.create (este archivo), o la técnica de la sintaxis class (archivo jugadores.js)"
 */
...
//↓↓↓ E2: Jugador
const Jugador = {
    arma: null,  //← E2: "Un Jugador no tiene un arma asignada cuando se crea."
...
Barbaro.equipar = function() {                         //← E2: "El método equipar() estará implementado en las clases hijas.(...) Cada implementación del método equipar() en las clase hijas realiza dos acciones:"
...
Elfo.equipar = function() {                           //← E2: "El método equipar() estará implementado en las clases hijas.(...) Cada implementación del método equipar() en las clase hijas realiza dos acciones:"
...
//↓↓↓ E5: Mago "Añade a la aplicación un nuevo tipo de jugador llamado Mago."
const Mago = Object.create(Jugador);

Mago.equipar = function() {                                 //← E5&2: "El método equipar() estará implementado en las clases hijas.(...) Cada implementación del método equipar() en las clase hijas realiza dos acciones:"
